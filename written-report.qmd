...
`Intercept`: When there are --- followers(mean follower amount), the hourly_max_salary is ---, there is no remote work allowed, and the experience level required is associate, **20.9%** of viewers applied to the position. 
